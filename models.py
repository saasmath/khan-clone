...
the new file:
cat <filename> | fgrep -o -w -e datetime -e logging -e json -e json -e math -e urllib -e pickle -e random -e itertools -e users -e memcache -e Rollback -e deferred -e taskqueue -e TransactionFailedError -e jsonify -e db -e object_property -e util -e user_util -e consts -e points -e Searchable -e App -e layer_cache -e request_cache -e models_discussion -e InteractiveTranscriptExperiment -e all_topics_list -e nicknames -e user_counter -e is_facebook_user_id -e FACEBOOK_ID_PREFIX -e AccuracyModel -e InvFnExponentialNormalizer -e clamp -e synchronized_with_memcache -e base64 -e os -e ImageCache -e age_util -e CredentialedUser -e slugify -e bingo -e GAEBingoIdentityModel -e StrugglingExperiment -e re -e library_content_html -e autocomplete -e templatetags -e MapLayout -e UpdateExercise -e UpdateExercise -e thumbnail_link_dict -e thumbnail_link_dict -e search -e exercise_save_data -e zlib -e traceback -e StringIO -e shared_jinja -e ClassDailyActivitySummary -e util_badges -e last_action_cache -e topic_exercise_badges -e util_notify -e GoalList -e exercise_sha1 | sort -u
...
from coache_resources.student_list_model import *
