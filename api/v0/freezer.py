...
"""
    ...
    We've frozen static versions of old v0 results to keep old friendly clients running
    that haven't managed to switch yet (like HP's Playbook app).
...
def freeze(api_url_suffix):
    ...
    request = urllib2.urlopen("http://www.khanacademy.org/api/%s" % api_url_suffix)
